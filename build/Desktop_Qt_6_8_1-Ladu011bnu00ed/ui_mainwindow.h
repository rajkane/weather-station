...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(lbl_pressure, 7, 0, 1, 1);
        ...
        lbl_wind = new QLabel(centralwidget);
        lbl_wind->setObjectName("lbl_wind");
        sizePolicy.setHeightForWidth(lbl_wind->sizePolicy().hasHeightForWidth());
        lbl_wind->setSizePolicy(sizePolicy);
        lbl_wind->setStyleSheet(QString::fromUtf8("font: 20pt \"Ubuntu Sans\";"));
        lbl_wind->setAlignment(Qt::AlignmentFlag::AlignCenter);

        gridLayout->addWidget(lbl_wind, 6, 0, 1, 1);

        lbl_sunrise_sunset = new QLabel(centralwidget);
        lbl_sunrise_sunset->setObjectName("lbl_sunrise_sunset");
        sizePolicy.setHeightForWidth(lbl_sunrise_sunset->sizePolicy().hasHeightForWidth());
        lbl_sunrise_sunset->setSizePolicy(sizePolicy);
        lbl_sunrise_sunset->setStyleSheet(QString::fromUtf8("font: 20pt \"Ubuntu Sans\";"));
        lbl_sunrise_sunset->setAlignment(Qt::AlignmentFlag::AlignCenter);

        gridLayout->addWidget(lbl_sunrise_sunset, 8, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lbl_wind->setText(QCoreApplication::translate("MainWindow", "Wind", nullptr));
        lbl_sunrise_sunset->setText(QCoreApplication::translate("MainWindow", "Sunrise Sunset", nullptr));
    } // retranslateUi
